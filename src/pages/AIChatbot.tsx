...
export default function AIChatbot() {
  const {
    ...
    messages, setMessages, loadingHistory,
    createConversation, saveMessage, deleteConversation, startNewChat,
  } = useChatHistory();
  ...
  return (
    <div className="container mx-auto max-w-5xl px-4 py-6 flex h-[calc(100vh-5rem)]">
      {/* Sidebar */}
      <div className={cn(
        "flex flex-col border-r border-border transition-all duration-300 overflow-hidden shrink-0",
      ...
      <div className="flex-1 flex flex-col min-w-0 pl-0">
        ...
        <Card className="flex-1 flex flex-col overflow-hidden border-border ml-4">
              ...
              <div className="space-y-4">
                {messages.map((msg, i) => (
                  <div key={i} className={`flex gap-3 ${msg.role === "user" ? "justify-end" : ""}`}>
                    ...
                    >
                      {msg.role === "assistant" ? (
                        <div className="prose prose-sm max-w-none text-sm [&_p]:my-1 [&_ul]:my-1 [&_ol]:my-1 [&_pre]:my-2">
